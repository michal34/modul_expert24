			...
			<div className="mx-auto flex max-w-[1100px] flex-col items-center px-6 text-center">
				<div className="mt-2 max-w-[980px]">
					...
					<p className="mx-auto mt-8 max-w-[900px] text-[16px] font-medium leading-[1.5] text-black md:text-[22px] lg:text-[26px]">
						Sprawna realizacja, indywidualna konfiguracja i możliwość dopasowania obiektu do
						warunków lokalizacji oraz potrzeb biznesu.
					</p>
				</div>

				<Link
					href="/kontakt"
					className="mt-16 inline-flex min-h-[52px] items-center justify-center rounded-full border border-[#ef9228] px-8 text-[15px] font-medium text-black transition-colors duration-300 hover:bg-[#ef9228] hover:text-[#13272f] md:min-h-[56px] md:px-12 md:text-[18px]"
				>
					Zamów wycenę
				</Link>
			</div>
